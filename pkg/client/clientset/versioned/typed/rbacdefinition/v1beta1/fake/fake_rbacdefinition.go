...
func (c *FakeRBACDefinitions) Get(name string, options v1.GetOptions) (result *v1beta1.RBACDefinition, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(rbacdefinitionsResource, c.ns, name), &v1beta1.RBACDefinition{})
...
func (c *FakeRBACDefinitions) List(opts v1.ListOptions) (result *v1beta1.RBACDefinitionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(rbacdefinitionsResource, rbacdefinitionsKind, c.ns, opts), &v1beta1.RBACDefinitionList{})
	...
	list := &v1beta1.RBACDefinitionList{ListMeta: obj.(*v1beta1.RBACDefinitionList).ListMeta}
...
func (c *FakeRBACDefinitions) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(rbacdefinitionsResource, c.ns, opts))
...
func (c *FakeRBACDefinitions) Create(rBACDefinition *v1beta1.RBACDefinition) (result *v1beta1.RBACDefinition, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(rbacdefinitionsResource, c.ns, rBACDefinition), &v1beta1.RBACDefinition{})
...
func (c *FakeRBACDefinitions) Update(rBACDefinition *v1beta1.RBACDefinition) (result *v1beta1.RBACDefinition, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(rbacdefinitionsResource, c.ns, rBACDefinition), &v1beta1.RBACDefinition{})
...
func (c *FakeRBACDefinitions) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(rbacdefinitionsResource, c.ns, name), &v1beta1.RBACDefinition{})
...
func (c *FakeRBACDefinitions) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(rbacdefinitionsResource, c.ns, listOptions)
...
func (c *FakeRBACDefinitions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.RBACDefinition, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(rbacdefinitionsResource, c.ns, name, pt, data, subresources...), &v1beta1.RBACDefinition{})
